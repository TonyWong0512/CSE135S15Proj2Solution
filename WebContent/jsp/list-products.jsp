    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <div class="modal fade" id="product-<%=p.getId()%>" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="products" method="post">
                                    ...
                                    <div>
                                        Category Name : <select id="cname" name="cname">
                                            <%
                                    ...
                                    <div>
                                        SKU : <input type="text" name="sku" id="sku" value="<%=p.getSKU()%>" size="40">
                                    </div>
                                    <div>
                                        Price : <input type="text" name="price" id="price" value="<%=p.getPrice()%>" size="40">
                                    </div>
...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <button data-toggle="modal" data-target="#newProduct">Insert</button>
        
        <div class="modal fade" id="newProduct" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div>
                                    ...
                                    <div>
                                        SKU : <input type="text" name="sku" id="sku" value="" size="40">
                                    </div>
                                    <div>
                                        Price : <input type="text" name="price" id="price" value="" size="40">
                                    </div>
