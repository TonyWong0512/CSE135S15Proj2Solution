                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="categories" method="post">
                                ...
                                <div>
                                    Description :
                                    <textarea name="description" id="description" cols=40 rows=6><%=cwc.getDescription()%></textarea>
                                </div>
                                <input type="text" name="id" id="id" value="<%=cwc.getId()%>" style="display: none"> <input
