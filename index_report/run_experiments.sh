...
psql -f customer_filter_category.sql -d cse135_small > hot_10MB/customer_filter_category
psql -f customer_filter_category.sql -d cse135_small > hot_10MB/customer_filter_category
sudo service postgresql stop
sudo sh -c "echo 3 > /proc/sys/vm/drop_caches"
sudo service postgresql start
psql -f customer_filter_category.sql -d cse135_big > cold_4.5GB/customer_filter_category

## search by customer no filters order by price
psql -f customer_no_filter_topk.sql -d cse135_small > hot_10MB/customer_no_filter_topk
psql -f customer_no_filter_topk.sql -d cse135_small > hot_10MB/customer_no_filter_topk
sudo service postgresql stop
sudo sh -c "echo 3 > /proc/sys/vm/drop_caches"
sudo service postgresql start
psql -f customer_no_filter_topk.sql -d cse135_big > cold_4.5GB/customer_no_filter_topk
